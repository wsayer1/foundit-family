...
export function ItemCardSkeleton() {
  return (
    <div className="w-full bg-white dark:bg-stone-900 rounded-2xl overflow-hidden shadow-sm">
      <div className="aspect-[4/3] bg-stone-200 dark:bg-stone-800 animate-pulse" />
      <div className="p-3">
        <div className="space-y-1.5">
          <div className="h-[18px] bg-stone-200 dark:bg-stone-700 rounded w-full animate-pulse" />
          <div className="h-[18px] bg-stone-200 dark:bg-stone-700 rounded w-2/3 animate-pulse" />
        </div>
        <div className="mt-2 flex items-center gap-1.5">
          <div className="w-5 h-5 rounded-full bg-stone-200 dark:bg-stone-700 flex-shrink-0 animate-pulse" />
          <div className="h-3.5 bg-stone-200 dark:bg-stone-700 rounded w-16 animate-pulse" />
          <div className="w-1 h-1 rounded-full bg-stone-200 dark:bg-stone-700" />
          <div className="h-3.5 bg-stone-200 dark:bg-stone-700 rounded w-12 animate-pulse" />
          <div className="w-1 h-1 rounded-full bg-stone-200 dark:bg-stone-700" />
          <div className="h-3.5 bg-stone-200 dark:bg-stone-700 rounded w-10 animate-pulse" />
        </div>
        <div className="mt-2">
