...
export function FloatingAuthCard({ onSuccess, onClose }: FloatingAuthCardProps) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 md:inset-0 z-40 md:flex md:items-center md:justify-center pointer-events-none">
      <div className="pointer-events-auto h-[33.33vh] md:h-auto md:w-[420px] flex flex-col bg-stone-950 rounded-t-3xl md:rounded-2xl shadow-2xl">
            ...
            >
              <div className="w-1/2 flex-shrink-0 pr-5">
                <div className="bg-stone-900 rounded-2xl p-1.5 mb-4">
                  <div className="relative flex">
                    <div
                      className="absolute top-0 bottom-0 w-1/2 bg-emerald-500 rounded-xl transition-transform duration-300 ease-out"
                      style={{
              ...
              <div className="w-1/2 flex-shrink-0 pl-5">
                <button
                  ...
                  className="flex items-center gap-1.5 text-stone-400 hover:text-white mb-4 -ml-1 transition-colors"
                >
                  <ArrowLeft size={16} />
