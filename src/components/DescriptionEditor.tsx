...
import { ArrowLeft, Loader2, Sparkles, Send, Tag, X, ChevronDown, Check } from 'lucide-react';
              ...
              <div className="flex items-center gap-2">
                {loading ? (
                  ...
                  <>
                    ...
                    <span className="text-sm text-stone-500 dark:text-stone-400">AI-generated</span>
                  </>
                )}
              </div>
              {!loading && (
